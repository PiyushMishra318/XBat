...
> Well you install XBat (get it x-box and battery. I will take whole credit for this cz AI could have probably come up with something better) and see the changes in battery life for your xbox controller in real time sorta (windows doesnt have drivers to track it very accurately).
